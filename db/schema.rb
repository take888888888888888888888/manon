...
ActiveRecord::Schema[7.1].define(version: 2024_04_15_035720) do
  ...
  create_table "room_tag_relations", force: :cascade do |t|
    t.integer "room_id", null: false
    t.integer "roomtag_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["room_id"], name: "index_room_tag_relations_on_room_id"
    t.index ["roomtag_id"], name: "index_room_tag_relations_on_roomtag_id"
  end
  ...
  add_foreign_key "room_tag_relations", "rooms"
  add_foreign_key "room_tag_relations", "roomtags"
